...
export type VCPFeatureCode = VCPFeatures.Audio | VCPFeatures.PresetOperation | VCPFeatures.DigitalPacketVideoLink |
    VCPFeatures.DisplayControl | VCPFeatures.Geometry | VCPFeatures.ImageAdjustment | VCPFeatures.Miscellaneous;
...
export class Display {
    getVcpFeature(featureCode: VCPFeatureCode): VCPValue;
    setVcpFeature(featureCode: VCPFeatureCode, value: number);
    setTableVcpFeature(featureCode: VCPFeatureCode, data: ArrayBuffer, offset: number);
